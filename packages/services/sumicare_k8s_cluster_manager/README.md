...
A GitOps service providing continuous delivery and infrastructure-as-code reconciliation for the Sumicare platform.
...
This service (`@sumicare/k8s-cluster-manager`) is a component of the Sumicare platform engineering toolkit.
...
> All graphic and media material used in this project is the property of the respective rights holders. See [ATTRIBUTION.md](./ATTRIBUTION.md) for full trademark and attribution details.
