...
Theia Cloud — a framework for deploying and managing Eclipse Theia-based IDEs and tools on Kubernetes, providing CRDs, a Java operator, and REST service for cloud-based development environments.
...
This chart (`@sumicare/theia-stack`) is a component of the Sumicare platform engineering toolkit.
