resource "kubernetes_manifest" "configmap_cnpg_cnpg_controller_manager_config" {
  manifest = {
    "apiVersion" = "v1"
    "data"       = {}
    "kind"       = "ConfigMap"
...
resource "kubernetes_manifest" "configmap_barman_cloud_plugin_barman_cloud_config" {
  manifest = {
    "apiVersion" = "v1"
    "kind"       = "ConfigMap"
    "metadata" = {
...
resource "kubernetes_manifest" "configmap_cnpg_cnpg_default_monitoring" {
  manifest = {
    "apiVersion" = "v1"
    "data" = {
      "queries" = <<-EOT
