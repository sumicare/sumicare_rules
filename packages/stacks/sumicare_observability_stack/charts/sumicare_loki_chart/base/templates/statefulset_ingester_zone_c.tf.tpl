...
resource "kubernetes_stateful_set" "loki_ingester_zone_c" {
  metadata {
    name      = "${local.app_name}-ingester-zone-c"
    ...
    template {
      ...
      spec {
        ...
        container {
          ...
          args  = ["-config.file=/etc/loki/config/config.yaml", "-target=ingester", "-ingester.availability-zone=zone-c"]
