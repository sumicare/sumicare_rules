...
resource "kubernetes_stateful_set" "loki_index_gateway" {
  metadata {
    name      = "${local.app_name}-index-gateway"
    namespace = var.namespace
    labels    = local.index_gateway_labels
  }

  spec {
    replicas = var.index_gateway_replicas
    ...
    template {
      ...
      spec {
        ...
        {{ NodeAffinityWithPodAntiAffinity "local.index_gateway_labels" }}
      }
    }
    ...
    service_name           = "${local.app_name}-index-gateway-headless"
